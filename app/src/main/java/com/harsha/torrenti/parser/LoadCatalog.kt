package com.harsha.torrenti.parser

import android.os.AsyncTask
import android.util.Log
import com.harsha.torrenti.fragments.MainFragment
...
/**
 * Created by Harsha on 20/04/2021.
 */
class LoadCatalog (private val url: String,
    ...
    private fun getData(url: String): Document? {
        return try {
            ...
            Jsoup.connect(u).timeout(90000).ignoreContentType(true).get()
        } catch (e: Exception) {
            Statics.nextPage = false
