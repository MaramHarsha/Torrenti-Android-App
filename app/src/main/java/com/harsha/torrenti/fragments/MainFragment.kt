package com.harsha.torrenti.fragments
...
import com.harsha.torrenti.adapters.MainAdapter
import com.harsha.torrenti.items.ItemTorrent
import com.harsha.torrenti.items.Statics
import com.harsha.torrenti.parser.LoadCatalog

@SuppressLint("ValidFragment")
/**
 * Created by Harsha on 12/04/2021.
 */
data class MainFragment(private val query: String) : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        searchCount.text = "$query: Searching internet, Please wait..."
        ...
        val adapter = object : MainAdapter(context) {
            ...
            override fun complate(count : Int) {
                if (count == 0) {
                    ...
                    searchCount.text = "$query: $count Results"
                }
            }
    ...
    private fun load (url : String) {
        if (isOnline(activity as android.support.v7.app.AppCompatActivity)) {
    ...
    private fun isOnline(activity: android.support.v7.app.AppCompatActivity): Boolean {
    ...
    private fun updateRecycler(item: ItemTorrent){
        ...
        (rv.adapter as MainAdapter).notifyItemChanged(0)
    }
